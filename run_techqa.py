...
def main():
    ...
    if args.do_eval:
        ...
        model_evaluator = partial(
                            predict_output, 
                            model_type=args.model_type, device=args.device, eval_features=test_features,
                            eval_dataset=test_dataset,
                            predict_batch_size=args.predict_batch_size,
                            nbest_size=args.n_best_size, n_to_predict=args.n_to_predict,
                            max_answer_length=args.max_answer_length, output_dir=args.output_dir,
                            gold_dict=gold_dict,
                            corpus=corpus,
